...
-  Fork this [repository](https://github.com/CodeChef-CIEM/CodeChef-CIEM.github.io)
  
-  Clone the forked https://github.com/<Your_Username>/CodeChef-CIEM.github.io
    > git clone https://github.com/<Your_Username>/CodeChef-CIEM.github.io.git
...
<br/>
// After Contributing add your name and GitHub handle at __Contributors Wall__
...
- Add the upstream (main project's) repo's URL
    ...
    > git remote add upstream https://github.com/CodeChef-CIEM/CodeChef-CIEM.github.io.git
